...
const ProtectedRoute = ({ allowedRoles = [] }) => {
  ...
  if (loading) {
    return (
      <div className="h-screen w-screen flex flex-col items-center justify-center bg-[#C8D8D9]" style={{ fontFamily: "'DM Sans', sans-serif" }}>
        <style>{`
          ...
          .ls-text { font-family: 'Syne', sans-serif; font-size: 18px; font-weight: 800; color: #1A3A42; letter-spacing: -0.01em; }
        `}</style>
